...
// SNAP Deal Board — Sam's lean internal acquisition tracker, a submodule under the SNAP menu.
    ...
    return (
      <>
        ...
        <main>
          ...
          <p className="muted">
            The SNAP Deal Board needs the <code>snap.deals</code> permission. Ask an administrator to grant it.
          </p>
        </main>
      </>
    );
